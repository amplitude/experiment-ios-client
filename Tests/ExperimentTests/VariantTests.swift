...
"""
let payloadObject = try! JSONSerialization.jsonObject(with: payloadObjectJson.data(using: .utf8)!, options: []) as! [String: ExperimentPropValue]

let payloadArrayJson = """
["testing","testing",123]
"""
let payloadArray = try! JSONSerialization.jsonObject(with: payloadArrayJson.data(using: .utf8)!, options: []) as! [ExperimentPropValue]
