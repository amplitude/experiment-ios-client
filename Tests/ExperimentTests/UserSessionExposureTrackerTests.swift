...
class UserSessionExposureTrackerTests : XCTestCase {
    ...
    func testTrackCalledOncePerFlag() {
        ...
        let exposure = Exposure(flagKey: "flag", variant: "variant", experimentKey: nil, metadata: nil)
        for _ in 0...10 {
        ...
        let exposure2 = Exposure(flagKey: "flag2", variant: "variant", experimentKey: nil, metadata: nil)
        for _ in 0...10 {
    ...
    func testTrackCalledAgainOnSameFlagWithVariantChangeValueToNull() {
        ...
        let exposure2 = Exposure(flagKey: "flag", variant: nil, experimentKey: nil, metadata: nil)
        for _ in 0...10 {
            tracker.track(exposure: exposure2)
        }
