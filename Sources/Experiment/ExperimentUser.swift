...
@objc public final class ExperimentUser: NSObject, Sendable {
    ...
    @objc public func getUserProperties() -> [String: Any]? {
        return userPropertiesAnyValue?.mapValues { $0 as Any }
    }

    internal func getSendableUserProperties() -> [String: any Sendable]? {
    ...
    public class Builder {
        ...
        @discardableResult
        public func groupProperties(_ groupProperties: [String: [String: [String: any Sendable]]]?) -> Builder {
...
internal extension ExperimentUser {
    ...
    func merge(_ user: ExperimentUser?) -> ExperimentUser {
        let mergedUserProperties = takeOrMerge(self.getSendableUserProperties(), user?.getSendableUserProperties()) { t, o in
