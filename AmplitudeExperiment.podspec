experiment_version = "1.16.1" # Version is managed automatically by semantic-release, please dont change it manually
...
Pod::Spec.new do |spec|
  ...
  spec.dependency 'AmplitudeCore', '>=1.0.6', '<2.0.0'
